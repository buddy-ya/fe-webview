...
export default function UniversitySelectPage() {
    ...
    return (
        <div className='p-3 w-full'>
            <header className='flex items-center h-[20px]'>
                <BackButton onClick={handleBack} />
            </header>
            <main className="h-[calc(100%-120px)]">
                <h2 className="mt-7 text-[24px]">세종대학교 재학생이신가요?</h2>
            ...
            <button className='flex items-center justify-center mt-3 w-full h-[60px] rounded-[12px] bg-primary' onClick={handleButtonClick} disabled={selectedUniv.id === 0}>
